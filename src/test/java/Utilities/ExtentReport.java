...
public class ExtentReport implements ITestListener{
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("SwagLab Automation Report"); // Title of report
		sparkReporter.config().setReportName("SwagLab Functional Testing"); // name of the report
